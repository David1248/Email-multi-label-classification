...
class Data():
    def __init__(self,
        ...
        #y_series = df['y']
        y_series = df[Config.ENCODED_COLS]
        ...
        self.X_train, self.X_test, self.y_train, self.y_test= train_test_split(X_good, y_good, test_size=new_test_size, random_state=0, stratify=None)#y_good)
        self.y = y_good
